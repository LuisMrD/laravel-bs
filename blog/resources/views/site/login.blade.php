...
<div class="flex justify-center items-center">
  <form class="w-full max-w-sm" method="post" action="/login/cadastrar" onsubmit="return confirm('Tem certeza?')">
    @csrf
    <div class="md:flex md:items-center mb-6 mt-24">
      ...
      <div class="md:w-2/3">
        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="nome" name="nome" type="text">
      </div>
    </div>
    ...
    <div class="md:flex md:items-center mb-6">
      ...
      <div class="md:w-2/3">
        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="celular" name="celular" type="text">
      </div>
    </div>
    <div class="md:flex md:items-center mb-6">
      <div class="md:w-1/3">
      ...
      <div class="inline-block relative w-64">
          <select id="UserType" name="UserType" @change="selectUserType()" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline">
      ...
      <div v-if="adm">
        <input type="hidden" id="statusadm" name="statusadm" value="0">
        <div class="md:flex md:items-center mb-6">
          <div class="md:w-1/3">
            <label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-full-name">
              Liga
    ...
    <input type="hidden" id="statusplayer" name="statusplayer" value="1">
  </form>
</div>
@endsection