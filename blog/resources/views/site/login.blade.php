...
<form class="w-full max-w-sm">
  ...
  <div class="md:w-1/3">
    ...
    <div class="inline-block relative w-64">
        <select name="UserType" @change="selectUserType()" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline">
